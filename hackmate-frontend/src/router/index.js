...
const PageLoader = () => (_jsx("div", { className: "flex h-screen items-center justify-center text-gray-400", children: "Loading\u2026" }));
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const wrap = (C) => (_jsx(Suspense, { fallback: _jsx(PageLoader, {}), children: _jsx(C, {}) }));
// Auth
...
export const router = createBrowserRouter([
    ...
    {
        path: '/participant',
        element: (_jsx(ProtectedRoute, { role: "participant", children: _jsx(AppShell, {}) })),
        children: [
    ...
    {
        path: '/mentor',
        element: (_jsx(ProtectedRoute, { role: "mentor", children: _jsx(AppShell, {}) })),
        children: [
            { index: true, element: _jsx(Navigate, { to: "dashboard", replace: true }) },
    ...
    {
        path: '/volunteer',
        element: (_jsx(ProtectedRoute, { role: "volunteer", children: _jsx(AppShell, {}) })),
        children: [
            { index: true, element: _jsx(Navigate, { to: "dashboard", replace: true }) },
    ...
    {
        path: '/admin',
        element: (_jsx(ProtectedRoute, { role: "admin", children: _jsx(AppShell, {}) })),
        children: [
            { index: true, element: _jsx(Navigate, { to: "dashboard", replace: true }) },
